...
let ConversationController = class ConversationController {
    ...
    async sendMessage(req, res, body) {
        const conversation = this.conversationService.sendMessage(req.user.id, req.params.placeId, body.message);
...
__decorate([
    ...
    common_1.Post('/:placeId/messages/send'),
